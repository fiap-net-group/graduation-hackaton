...
namespace Graduation.Hackaton.VideoProcessing.Infrastructure.Logger
{
    [ExcludeFromCodeCoverage]
    public sealed class ConsoleLoggerGateway : ILoggerGateway
    {
        private readonly ILogger<ConsoleLoggerGateway> _logger;
        private readonly LoggerManagerSeverity _minLevel;

        public ConsoleLoggerGateway(ILogger<ConsoleLoggerGateway> logger, IConfiguration configuration)
        {
            _logger = logger;
